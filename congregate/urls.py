...
urlpatterns = [
    ...
    path('attend/<int:event_id>', views.AttendEvent.as_view(), name='attend_event'),
    path('remove-attend/<int:event_id>', views.RemoveAttendEvent.as_view(), name='remove_attend_group'),
